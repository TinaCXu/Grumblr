...
urlpatterns = [
    ...
    path('personal_stream/',views.FollowPostView,name='personal_stream'),
    path('update_post/<str:timestamp>',views.UpdatePostView,name='update_post'),
    path('update_follow_post/<str:timestamp>',views.UpdateFollowPostView,name='update_follow_post'),
