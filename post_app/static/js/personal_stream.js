                ...
                +'<div class="card w-90">' 
                    +'<div class="card-body">'
                        ...
                        +'<div class="container">'
                            +'<div class="row">'
                                +'<div class="col-2">'
                                    +'<a href="http://127.0.0.1:8000/personal/">'
                                        +'<img src="https://img.zcool.cn/community/014a44576a87420000012e7ee026ab.png@1280w_1l_2o_100sh.png" width="col-3" height="col-3" class="card-img-top" alt="User2">'
                                    +'</a>'
                                +'</div>'
                                +'<div class="col-10">'
                                    +new_post["post"]
